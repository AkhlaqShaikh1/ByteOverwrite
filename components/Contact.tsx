        ...
        <div className="max-w-2xl mx-auto">
          <div className="glass p-12 rounded-2xl">
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:contact@byteoverwrite.com"
                    className="text-purple-light hover:text-purple-dark transition-colors text-lg"
                  >
                    contact@byteoverwrite.com
                  </a>
                </div>
              </div>
            ...
            <div className="mt-8 text-center">
              <a
                href="mailto:contact@byteoverwrite.com"
                className="inline-block gradient-btn px-8 py-4 rounded-full text-lg font-semibold text-white"
              >
